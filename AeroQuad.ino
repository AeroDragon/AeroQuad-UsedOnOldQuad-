...
//    #define SPARKFUN_5883L_BOB
  ...
  void initPlatform() {
    ...
    Wire.begin();
    TWBR = 12;
    initializeMPU6000Sensors();   //Init new sensor//////////////////////////////////////////////////////
  }
  ...
  #define LED_Red 4
  #define LED_Yellow 31
  #define MPU6000_I2C  //Define new sensor/////////////////////////////////////////////////////


  #include <Device_I2C.h>

  // Gyroscope declaration
//  #define ITG3200_ADDRESS_ALTERNATE     --no need for the old sensors now.////////////////////////////////
//  #include <Gyroscope_ITG3200_9DOF.h>
  #include <Platform_MPU6000.h>          // next 3 lines allow access to the MPU6050 gyro and Accelrometer 
